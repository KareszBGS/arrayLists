...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> arrayNotThree = new ArrayList<>();
        ...
        for (int i = 0; i < data.length; i++) {
            if (data[i] % 2 == 0) {
                arrayEven.add(data[i]);
            }
        }

        // ArrayList of string numbers
        for (int i = 0; i < data.length; i++) {
            String thing = Integer.toString(data[i]);
            arrayStrings.add(thing);
        }

        // All 3 digits
        for (int i = 0; i < arrayStrings.size(); i++) {
            String current = arrayStrings.get(i);
            if (current.length() == 3) {
        ...
        arrayNotThree = arrayL;
        for (int i = 0; i < arrayNotThree.size(); i++) {
            int thisOne = arrayNotThree.get(i);
            if (thisOne % 3 == 0) {
                arrayNotThree.remove(i);
                i--;
            }
        }
